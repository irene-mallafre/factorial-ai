export default function Ticket_WorkshopBudget() {
  return (
    <div className="home-window-scroll min-h-0 flex-1 overflow-auto">
      <div className="flex flex-col gap-3 px-5 pb-1 pt-3">
        <h2 className="text-xl font-semibold text-f1-foreground">Approve €890 design team workshop</h2>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="flex h-8 items-center gap-2 text-base">
            ...
            <span className="font-medium text-f1-foreground">T-00051</span>
          </span>
        </div>
      </div>
      <div className="px-5 py-3">
        <div className="overflow-hidden rounded-md border border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">
              <div className="flex w-fit max-w-full flex-row items-center justify-start gap-1">
                <div className="inline-flex w-fit max-w-full flex-row items-center justify-start gap-1 py-0.5 pr-2 text-base font-medium pl-1 rounded-full bg-f1-background-secondary text-f1-foreground-secondary">
                  ...
                  <span className="min-w-0 max-w-full overflow-hidden text-ellipsis block whitespace-nowrap" data-testid="one-ellipsis">Low</span>
                </div>
              </div>
            </div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">
              <span className="flex size-5 shrink-0 items-center justify-center rounded-[6px] bg-f1-background-promote-bold text-sm font-medium text-f1-foreground-inverse">L</span>
          ...
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">Training</div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
          ...
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">01/06/2026</div>
          </div>
          <div className="flex min-h-11 items-center px-3 ">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground"><span>9 days left</span></div>
          </div>
        </div>
      </div>
      <section className="flex flex-col gap-3 px-5 py-3">
        <h3 className="text-lg font-semibold text-f1-foreground">Description</h3>
        <p className="text-base text-f1-foreground">€890 for a one-day design workshop, requested by Marta. It comes out of the Q2 L&D budget, which still has room.</p>
      </section>
      <section className="flex flex-col gap-3 px-5 py-3">
      ...
      <section className="flex flex-col gap-3 px-5 py-3">
        ...
        <textarea rows={4} aria-label="Comment on Approve €890 design team workshop" placeholder="Write a comment…" className="w-full resize-none rounded-md border border-solid border-f1-border bg-f1-background p-3 text-base text-f1-foreground outline-none placeholder:text-f1-foreground-tertiary"></textarea>
      </section>
    </div>
  )
}
