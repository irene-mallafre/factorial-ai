...
export default function ChatMessages_Incidencias() {
  return (
    <>
      <div className="flex items-end gap-2">
        ...
        <div className="f0c-chat-bubble w-[71%] min-w-0 rounded-xl px-4 py-3" style={{ "--f0c-author": "126 74 156" } as React.CSSProperties}>
          ...
          <p className="text-base text-f1-foreground">La caja 2 de Tienda Centro no imprime tickets.</p>
        </div>
      </div>
      <div className="flex items-end gap-2">
        <div className="shrink-0">
        ...
        <div className="f0c-chat-bubble w-[71%] min-w-0 rounded-xl px-4 py-3" style={{ "--f0c-author": "172 88 32" } as React.CSSProperties}>
          ...
          <p className="text-base text-f1-foreground">Voy para allá, llevo el rollo de repuesto.</p>
        </div>
      </div>
      <div className="flex flex-col items-end gap-2">
        <div className="w-[77%] min-w-0 rounded-xl bg-f1-background-tertiary px-4 py-3">
          <div className=""><p className="text-base text-f1-foreground">Resuelto, gracias 🙌</p></div>
        </div>
        <span className="text-sm text-f1-foreground-secondary">Read 11:05</span>
      </div>
    </>
  )
}
