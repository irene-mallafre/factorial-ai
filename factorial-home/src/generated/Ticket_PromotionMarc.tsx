export default function Ticket_PromotionMarc() {
  return (
    <div className="home-window-scroll min-h-0 flex-1 overflow-auto">
      <div className="flex flex-col gap-3 px-5 pb-1 pt-3">
        <h2 className="text-xl font-semibold text-f1-foreground">Approve Marc's promotion to Senior</h2>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="flex h-8 items-center gap-2 text-base">
            ...
            <span className="font-medium text-f1-foreground">T-00040</span>
          </span>
        </div>
      </div>
      <div className="px-5 py-3">
        <div className="overflow-hidden rounded-md border border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">
              <div className="flex w-fit max-w-full flex-row items-center justify-start gap-1">
                <div className="inline-flex w-fit max-w-full flex-row items-center justify-start gap-1 py-0.5 pr-2 text-base font-medium pl-1 rounded-full bg-f1-background-warning text-f1-foreground-warning">
                  ...
                  <span className="min-w-0 max-w-full overflow-hidden text-ellipsis block whitespace-nowrap" data-testid="one-ellipsis">High</span>
                </div>
              </div>
            </div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">
              <span className="flex size-5 shrink-0 items-center justify-center rounded-[6px] bg-f1-background-promote-bold text-sm font-medium text-f1-foreground-inverse">P</span>
              <span className="truncate">People Ops</span>
            </div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
          ...
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">Performance</div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
              ...
              <div className="relative inline-flex h-fit w-fit">
                <div className="relative h-fit w-fit">
                  <span data-a11y-color-contrast-ignore="true" className="relative flex shrink-0 items-center justify-center overflow-hidden text-center font-semibold ring-1 ring-inset ring-f1-border-secondary size-5 text-sm rounded-full bg-f1-background-inverse-secondary dark:bg-f1-background-tertiary" role="img" aria-hidden="true" translate="no">
                    <img className="aspect-square h-full w-full object-cover" alt="M" loading="lazy" src="https://i.pravatar.cc/120?u=marc-roig" />
                  </span>
                </div>
              </div>
              <span className="truncate">Marc Roig</span>
            </div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            <span className="w-40 shrink-0 truncate text-base text-f1-foreground-secondary">Created on</span>
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">26/05/2026</div>
          </div>
          <div className="flex min-h-11 items-center px-3 ">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground"><span>1 day left</span></div>
          </div>
        </div>
      </div>
      <section className="flex flex-col gap-3 px-5 py-3">
        <h3 className="text-lg font-semibold text-f1-foreground">Description</h3>
        <p className="text-base text-f1-foreground">Two years at Mid, three consecutive reviews at 4.5 or above, and the promotion committee has already signed off. The band change takes effect next payroll.</p>
      </section>
      <section className="flex flex-col gap-3 px-5 py-3">
      ...
      <section className="flex flex-col gap-3 px-5 py-3">
        ...
        <textarea rows={4} aria-label="Comment on Approve Marc's promotion to Senior" placeholder="Write a comment…" className="w-full resize-none rounded-md border border-solid border-f1-border bg-f1-background p-3 text-base text-f1-foreground outline-none placeholder:text-f1-foreground-tertiary"></textarea>
      </section>
    </div>
  )
}
