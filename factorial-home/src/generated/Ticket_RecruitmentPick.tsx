export default function Ticket_RecruitmentPick() {
  return (
    <div className="home-window-scroll min-h-0 flex-1 overflow-auto">
      <div className="flex flex-col gap-3 px-5 pb-1 pt-3">
        <h2 className="text-xl font-semibold text-f1-foreground">Pick Lucia for Senior Designer</h2>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="flex h-8 items-center gap-2 text-base">
            ...
            <span className="font-medium text-f1-foreground">T-00021</span>
          </span>
        </div>
      </div>
      <div className="px-5 py-3">
        <div className="overflow-hidden rounded-md border border-solid border-f1-border-secondary">
          ...
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">
              <span className="flex size-5 shrink-0 items-center justify-center rounded-[6px] bg-f1-background-promote-bold text-sm font-medium text-f1-foreground-inverse">T</span>
          ...
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground"><span className="text-f1-foreground-secondary">Marta Ibáñez</span></div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            <span className="w-40 shrink-0 truncate text-base text-f1-foreground-secondary">Category</span>
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">Recruitment</div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">
              ...
              <span className="truncate">Lucía Fernandez</span>
            </div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            <span className="w-40 shrink-0 truncate text-base text-f1-foreground-secondary">Created on</span>
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">21/05/2026</div>
          </div>
          <div className="flex min-h-11 items-center px-3 ">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground"><span className="text-f1-foreground-critical">3 days overdue</span></div>
          </div>
        </div>
      </div>
      <section className="flex flex-col gap-3 px-5 py-3">
        <h3 className="text-lg font-semibold text-f1-foreground">Description</h3>
        <p className="text-base text-f1-foreground">Fourteen interviews are done and the panel scored Lucía 9.2 out of 10. The offer sits inside the band for Senior Designer, so this only needs your sign-off.</p>
      </section>
      <section className="flex flex-col gap-3 px-5 py-3">
      ...
      <section className="flex flex-col gap-3 px-5 py-3">
        ...
        <textarea rows={4} aria-label="Comment on Pick Lucia for Senior Designer" placeholder="Write a comment…" className="w-full resize-none rounded-md border border-solid border-f1-border bg-f1-background p-3 text-base text-f1-foreground outline-none placeholder:text-f1-foreground-tertiary"></textarea>
      </section>
    </div>
  )
}
