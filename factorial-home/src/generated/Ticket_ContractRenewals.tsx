export default function Ticket_ContractRenewals() {
  return (
    <div className="home-window-scroll min-h-0 flex-1 overflow-auto">
      <div className="flex flex-col gap-3 px-5 pb-1 pt-3">
        <h2 className="text-xl font-semibold text-f1-foreground">Confirm 4 contract renewals</h2>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="flex h-8 items-center gap-2 text-base">
            ...
            <span className="font-medium text-f1-foreground">T-00034</span>
          </span>
        </div>
      </div>
      <div className="px-5 py-3">
        <div className="overflow-hidden rounded-md border border-solid border-f1-border-secondary">
          ...
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">Contracts</div>
          </div>
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
          ...
          <div className="flex min-h-11 items-center px-3 border-0 border-b border-solid border-f1-border-secondary">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground">30/05/2026</div>
          </div>
          <div className="flex min-h-11 items-center px-3 ">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 text-base text-f1-foreground"><span>6 days left</span></div>
          </div>
        </div>
      </div>
      <section className="flex flex-col gap-3 px-5 py-3">
        <h3 className="text-lg font-semibold text-f1-foreground">Description</h3>
        <p className="text-base text-f1-foreground">Four renewals, already drafted and within standard policy and budget. Nothing in them departs from the template you approved in February.</p>
      </section>
      <section className="flex flex-col gap-3 px-5 py-3">
      ...
      <section className="flex flex-col gap-3 px-5 py-3">
        ...
        <textarea rows={4} aria-label="Comment on Confirm 4 contract renewals" placeholder="Write a comment…" className="w-full resize-none rounded-md border border-solid border-f1-border bg-f1-background p-3 text-base text-f1-foreground outline-none placeholder:text-f1-foreground-tertiary"></textarea>
      </section>
    </div>
  )
}
