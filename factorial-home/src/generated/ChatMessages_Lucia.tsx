...
export default function ChatMessages_Lucia() {
  return (
    <>
      <div className="flex items-end gap-2">
        ...
        <div className="f0c-chat-bubble w-[71%] min-w-0 rounded-xl px-4 py-3" style={{ "--f0c-author": "22 114 106" } as React.CSSProperties}>
          ...
          <p className="text-base text-f1-foreground">¿Puedes cubrir el sábado por la mañana? Tengo médico.</p>
        </div>
      </div>
      <div className="flex flex-col items-end gap-2">
        <div className="w-[77%] min-w-0 rounded-xl bg-f1-background-tertiary px-4 py-3">
          <div className=""><p className="text-base text-f1-foreground">Sí, sin problema. Lo apunto.</p></div>
        </div>
        <span className="text-sm text-f1-foreground-secondary">Read 09:12</span>
      </div>
      <div className="flex items-end gap-2">
        <div className="shrink-0">
          <div className="relative inline-flex h-fit w-fit">
        ...
        <div className="f0c-chat-bubble w-[71%] min-w-0 rounded-xl px-4 py-3" style={{ "--f0c-author": "22 114 106" } as React.CSSProperties}>
          <span className="f0c-chat-author block truncate text-sm font-medium">Lucía Fernandez</span>
          <p className="text-base text-f1-foreground">Gracias, te debo una ☕</p>
        </div>
      </div>
    </>
  )
